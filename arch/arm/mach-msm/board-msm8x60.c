...
#if defined(CONFIG_MACH_MSM8X60_PRESTO) // p13777 kej 110623
...
#if defined(CONFIG_MACH_MSM8X60_PRESTO) // kkcho_temp_presto
...
#if defined(CONFIG_MACH_MSM8X60_PRESTO) || defined(CONFIG_MACH_MSM8X60_EF39S) || defined(CONFIG_MACH_MSM8X60_EF40K) || defined(CONFIG_MACH_MSM8X60_EF40S)
	[2] = {
